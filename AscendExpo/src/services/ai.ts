...
function localFallback(
  ...
  const body = `Picture your mornings in a life that matches what you described: ${tags}. You move with the traits you chose: ${traits}. The world still asks hard questions, especially around ${fears}, but you answer with motion—small, repeatable, undeniable.
